...
# code to show the plot of raw data ("population data") i.e. Data given in data.csv
# fig = ff.create_distplot([data],["temp"],show_hist=False)
# fig.show() 

#Code to find the mean and standard deviation of the raw data ("population data")
...
# That means from entire raw data, 100 data points will be selected.
# That is called as sample data.So one sample data will be formed which will have 100 data points.
# dataset = []
...
# That means 1000 sample data will be formed.
# Each sample data will have 100 data points.  
